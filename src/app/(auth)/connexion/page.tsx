...
function ConnexionForm() {
  ...
  const callbackUrl = raw?.startsWith("/") ? raw : "/mon-espace";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-secondary/30 px-4">
      <div className="w-full max-w-md">
        ...
        <Suspense fallback={<div className="bg-card border border-border rounded-2xl p-8 text-center text-muted-foreground">Chargement...</div>}>
          <ConnexionForm />
        </Suspense>
      </div>
    </div>
